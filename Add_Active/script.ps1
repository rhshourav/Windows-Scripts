...
& {
    ...
    $expectedHash = 'A953332EFF776B248C9C93553F4746138667AC8F5EF115F20C8DA10F318EB4E6'
    ...
    if ($hash -ne $expectedHash) {
        Write-Warning "Hash mismatch (continuing execution)."
    }
