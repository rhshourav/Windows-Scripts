...
## Usage
### One command to install ERP
```
irm https://raw.githubusercontent.com/rhshourav/Windows-Scripts/refs/heads/main/ERP-Automate/run_Auto-ERP.ps1 | iex
```
### One command to install ERP Fonts
```
irm https://raw.githubusercontent.com/rhshourav/Windows-Scripts/refs/heads/main/ERP-Automate/ | iex
```
...
Created by the ERP automation team.

```

If you want, I can **also update the script itself** to actually implement **Base64-encoded paths** so that the network share and DLL location aren’t visible in plain text anymore. This would make it safer to distribute.  
